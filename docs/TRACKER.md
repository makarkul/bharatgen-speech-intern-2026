...
| Week 2 | how_to_run_an_hf_model.md | Tutorial: AutoModel/Tokenizer/Processor, cache, eval mode, no_grad. Code + screenshots. | Writing-for-others test of understanding. | Done (with caveats) | https://github.com/makarkul/bharatgen-speech-intern-2026/pull/7 |
